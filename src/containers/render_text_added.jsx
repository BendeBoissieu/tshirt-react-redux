    ...
    return (
      <div className="background-tshirt">
        <Moveable
          ...
          draggable={this.props.menuActive == 'add_text' ? true : false}
          scalable={this.props.menuActive == 'add_text' ? true : false}
          rotatable={this.props.menuActive == 'add_text' ? true : false}
          origin={false}
          dragArea={true}
          keepRatio={true}
